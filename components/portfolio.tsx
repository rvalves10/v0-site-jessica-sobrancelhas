...
const portfolioItems = [
  ...
  },
  {
    ...
    category: "Limpeza e Alinhamento",
  },
]
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="font-sans text-lg text-muted-foreground font-light">
            Cada detalhe importa. Veja alguns dos meus trabalhos e a beleza natural em destaque.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          {portfolioItems.map((item) => (
            ...
            >
              ...
              {/* Content */}
              <div
                className={`absolute bottom-0 left-0 right-0 p-4 lg:p-6 transition-all duration-300 ${
                  hoveredId === item.id ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
                }`}
              >
                <p className="font-sans text-xs uppercase tracking-widest text-primary-foreground/80 mb-1">
                  {item.category}
                </p>
                <h3 className="font-serif text-lg lg:text-xl font-semibold text-primary-foreground">
                  {item.title}
                </h3>
              </div>
            </div>
        ...
        <div className="mt-12 text-center">
          <p className="font-sans text-muted-foreground font-light mb-4">
            Quer ver mais resultados? Me acompanhe no Instagram!
          </p>
          <a
